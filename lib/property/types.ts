...
export const propertyFields: PropertyField[] = [
  ...
  { key: 'floor', label: 'الدور', section: 'details', kind: 'select', options: referenceOptions.floors },
  { key: 'floorType', label: 'نوع الطابق', section: 'details', kind: 'text', placeholder: 'أرضي / متكرر / أخير ...' },
