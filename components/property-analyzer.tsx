...
export function PropertyAnalyzer({ activeAgentName }: PropertyAnalyzerProps) {
  ...
  return (
    <main dir="rtl" className="min-h-screen bg-transparent text-foreground">
      <header className="sticky top-0 z-40 border-b border-primary/25 bg-[color-mix(in_oklab,var(--background)_82%,var(--primary)_18%)]/90 shadow-[0_8px_30px_-14px_color-mix(in_oklab,var(--primary)_45%,transparent)] backdrop-blur-2xl">
